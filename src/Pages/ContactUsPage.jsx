...
const ContactUsPage = () => {
  return (
    <div>
      {/* header */}
      <div
        className={`relative h-[350px] md:h-[440px] 2xl:h-[500px] flex items-end md:pb-11 justify-center bg-cover bg-bottom bg-[linear-gradient(111deg,rgba(0,33,21,0.8)_45.72%,rgba(12,53,60,0.2)_98.54%),url('/contact-us-bg.png')]`}
      >
