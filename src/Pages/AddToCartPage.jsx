      ...
      {cartItems.length === 0 ? (
        ...
        <div className="w-full flex flex-col lg:flex-row gap-6 md:gap-9">
          <div className="flex flex-col gap-6 md:gap-9 flex-1 min-w-0">
            <div className="flex h-14 sm:h-16 md:h-20 px-6 md:px-8 py-6 md:py-[37px] flex-col justify-center items-start gap-2.5 self-stretch rounded-2xl bg-linear-to-r from-[#C1C79E] to-[#9EAA55] text-[#051619] text-lg sm:text-xl md:text-2xl font-semibold leading-[130%]">
              Product Details
            </div>
          ...
          {/* order summary */}
          <div className="w-full lg:w-[363px] lg:shrink-0">
            <OrderSummary />
          </div>
        </div>
      )}
