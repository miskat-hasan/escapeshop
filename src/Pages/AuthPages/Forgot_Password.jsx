        ...
        >
          ...
          <div className="w-full space-y-4">
            ...
            <div>
              ...
              <input
                type="email"
                className={`flex h-12 sm:h-[52px] py-2 px-3 items-center gap-2 self-stretch rounded-xl border border-[#C1C79E] bg-white text-[#818898] text-base font-normal leading-6 w-full ${errors.email && "border-red-400"}`}
