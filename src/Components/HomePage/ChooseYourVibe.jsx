    ...
    <div className="container py-14">
      ...
      <div className="mt-12 grid grid-cols-1 xs:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-2 sm:gap-3 lg:gap-6">
        {contents?.map((item, index) => (
          <div
            key={index}
            className="flex sm:min-w-[200px] w-full p-3 sm:p-4 flex-col items-center gap-2 sm:gap-4 shrink-0 rounded-2xl border-[0.4px] border-solid border-[#4c751d] bg-[linear-gradient(112deg,#C1C79E_3.64%,rgba(91,102,27,0.80)_98.65%)]"
          >
