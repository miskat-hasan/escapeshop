...
const HeroSection = () => {
  return (
    <div className="relative h-[900px] flex items-center justify-center bg-cover bg-center bg-[linear-gradient(111deg,rgba(0,33,21,0.8)_45.72%,rgba(12,53,60,0.16)_98.54%),url('/hero-bg.png')]">
