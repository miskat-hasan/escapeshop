...
const PageHeader = () => {
  return (
    <div
      className={`relative h-[440px] 2xl:h-[500px] flex items-end pb-11 justify-center bg-cover bg-bottom bg-[linear-gradient(180deg,#0D3023_4.39%,rgba(21,23,23,0.2)_100%),url('/products-page-bg.png')]`}
    >
