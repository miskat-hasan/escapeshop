...
const inputBase =
  "flex w-full h-12 sm:h-[72px] px-3 sm:p-6 items-center gap-[10px] self-stretch rounded-md sm:rounded-2xl border-[0.4px] bg-white/10 text-[#D1D5DC] text-sm sm:text-base font-normal leading-[150%] outline-none transition-colors placeholder:text-[#D1D5DC]/50";
...
const CustomerInformation = () => {
  ...
  return (
    ...
    >
      ...
      {/* Postcode + Street — side by side on sm+ */}
      <div className="flex flex-col sm:flex-row gap-5 md:gap-6 w-full">
        {/* Postcode */}
        <div className="space-y-2 md:space-y-3 flex-1">
          <p className="text-white text-base md:text-[18px] font-medium leading-[150%]">
      ...
      <div className="space-y-2 md:space-y-3 w-full">
        ...
        <textarea
          rows={3}
          className={`flex w-full p-3 sm:p-6 gap-[10px] self-stretch rounded-2xl border-[0.4px] border-[#5C787C] bg-white/10 text-[#D1D5DC] text-sm sm:text-base font-normal leading-[150%] outline-none focus:border-[#C1C79E] transition-colors resize-none placeholder:text-[#D1D5DC]/50`}
      ...
      <button
        type="submit"
        className="flex lg:hidden w-full cursor-pointer h-11 sm:h-14 p-2.5 justify-center items-center gap-2.5 rounded-lg bg-[#C1C79E] text-[#051619] text-center text-base font-medium leading-[150%]"
      >
        Proceed to Checkout
      </button>
    </form>
